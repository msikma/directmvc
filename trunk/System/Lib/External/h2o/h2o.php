...
require H2O_ROOT.'sources/datatype.php';
require H2O_ROOT.'sources/loaders.php';
require H2O_ROOT.'sources/nodes.php';
require H2O_ROOT.'sources/tags.php';
require H2O_ROOT.'sources/errors.php';
require H2O_ROOT.'sources/filters.php';
require H2O_ROOT.'sources/context.php';
...
class H2o {
    ...
    function parse($source, $filename = '', $env = null) {
        ...
        if (!class_exists('H2o_Parser'))
            require H2O_ROOT.'sources/parser.php';
